...
public class Calendrier {
    ...
    private String debut_periode; // la date du début de la période ou l'utilisateur souhaite planifier ses tâches
    private String fin_periode; // la date de la fin de la période ou l'utilisateur souhaite planifier ses
                                // tâches
    private ArrayList<Tache> non_planifie; // liste des tâches qui n'ont pas encore été planifiées

    public Calendrier(Journee[][] mat_journees, ArrayList<Projet> projets, String debut_periode, String fin_periode,
            ArrayList<Tache> non_planifie) {
        int i, j;
